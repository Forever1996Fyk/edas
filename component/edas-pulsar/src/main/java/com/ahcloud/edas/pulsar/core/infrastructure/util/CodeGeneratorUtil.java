...
public class CodeGeneratorUtil {
    ...
    public static void main(String[] args) {
        ...
        //todo 需要生成的表
        String[] tables = new String[]{"pulsar_topic_stats", "pulsar_producer_stats", "pulsar_consumer_stats", "pulsar_subscription_stats"};
        ...
        String srcPath = projectPath + "/component/edas-pulsar/src/main/java";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/edas-pulsar?nullCatalogMeansCurrent=true&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8&useSSL=false")
        ...
        pc.setParent("");
        pc.setEntity("com.ahcloud.edas.pulsar.core.infrastructure.repository.bean")
                .setMapper("com.ahcloud.edas.pulsar.core.infrastructure.repository.mapper")
                .setService("com.ahcloud.edas.pulsar.core.application.service")
                .setServiceImpl("com.ahcloud.edas.pulsar.core.application.service.impl")
        ;
        Map<String, String> packageInfo = new HashMap<>();
        packageInfo.put(ConstVal.ENTITY, "com.ahcloud.edas.pulsar.core.infrastructure.repository.bean");
        packageInfo.put(ConstVal.MAPPER, "com.ahcloud.edas.pulsar.core.infrastructure.repository.mapper");
        packageInfo.put(ConstVal.SERVICE, "com.ahcloud.edas.pulsar.core.application.service");
        packageInfo.put(ConstVal.SERVICE_IMPL, "com.ahcloud.edas.pulsar.core.application.service.impl")
        ;
