package com.ahcloud.edas.devops.common.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseResult<Void> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException e) {
        return ResponseResult.ofFailed(DevopsRetCodeEnum.PARAM_ILLEGAL);
    }
    ...
    public ResponseResult<Void> constraintViolationException(ConstraintViolationException e) {
        ...
        return ResponseResult.ofFailed(DevopsRetCodeEnum.PARAM_ILLEGAL.getCode(), errorMsg.toString());
    }
    ...
    public ResponseResult<Void> handleBindException(BindException ex) {
        ...
        String errorMsg = DevopsRetCodeEnum.PARAM_ILLEGAL.getMessage();
        if (Objects.nonNull(fieldError)) {
            errorMsg = fieldError.getDefaultMessage();
        }
        // 生成返回结果
        return ResponseResult.ofFailed(DevopsRetCodeEnum.PARAM_ILLEGAL.getCode(), errorMsg);
    }
}
