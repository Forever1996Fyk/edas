package com.ahcloud.edas.nacos.biz.infrastructure.util;
...
public class CodeGeneratorUtil {
    ...
    public static void main(String[] args) {
        ...
        //todo 需要生成的表
        String[] tables = new String[]{"app_resource", "nacos_config"};
        ...
        String srcPath = projectPath + "/component/edas-nacos/src/main/java";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/edas-nacos?nullCatalogMeansCurrent=true&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8&useSSL=false")
        ...
        pc.setParent("");
        pc.setEntity("com.ahcloud.edas.nacos.biz.infrastructure.repository.bean")
                .setMapper("com.ahcloud.edas.nacos.biz.infrastructure.repository.mapper")
                .setService("com.ahcloud.edas.admin.biz.application.service")
                .setServiceImpl("com.ahcloud.edas.admin.biz.application.service.impl")
        ;
        Map<String, String> packageInfo = new HashMap<>();
        packageInfo.put(ConstVal.ENTITY, "com.ahcloud.edas.nacos.biz.infrastructure.repository.bean");
        packageInfo.put(ConstVal.MAPPER, "com.ahcloud.edas.nacos.biz.infrastructure.repository.mapper");
        packageInfo.put(ConstVal.SERVICE, "com.ahcloud.edas.admin.biz.application.service");
        packageInfo.put(ConstVal.SERVICE_IMPL, "com.ahcloud.edas.admin.biz.application.service.impl")
        ;
