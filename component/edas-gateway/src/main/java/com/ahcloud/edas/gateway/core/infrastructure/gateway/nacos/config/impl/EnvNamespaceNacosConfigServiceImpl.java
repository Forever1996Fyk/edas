package com.ahcloud.edas.gateway.core.infrastructure.gateway.nacos.config.impl;
 ...
 * @description:
 * @author: YuKai Fan
 * @create: 2023/12/7 22:28
 **/
public class EnvNamespaceNacosConfigServiceImpl implements NamespaceNacosConfigService {
    private static final Logger LOGGER = LogUtils.logger(EnvNamespaceNacosConfigServiceImpl.class);
    ...
    public EnvNamespaceNacosConfigServiceImpl(Properties properties) throws NacosException {
    ...
    @Override
    public boolean publishConfigWithNamespace(String namespace, String dataId, String group, String content) throws NacosException {
        return publishConfigInner(namespace, dataId, group, null, null, null, content, ConfigType.getDefaultType().getType(), null);
    }

    @Override
    public boolean publishConfigWithNamespace(String namespace, String dataId, String group, String content, String type) throws NacosException {
        return publishConfigInner(namespace, dataId, group, null, null, null, content, type, null);
    }
