 ...
 * @description:
 * @author: YuKai Fan
 * @create: 2023/12/8 16:03
 **/
public class NamespaceNacosNamingService implements NamingService {
    ...
    public NamespaceNacosNamingService(String serverList) throws NacosException {
        Properties properties = new Properties();
        properties.setProperty(PropertyKeyConst.SERVER_ADDR, serverList);
        init(properties);
    }

    public NamespaceNacosNamingService(String namespace, Properties properties) throws NacosException {
