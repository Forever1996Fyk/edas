package com.ahcloud.edas.admin.biz.infrastructure.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseResult<Void> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException e) {
        return ResponseResult.ofFailed(ErrorCodeEnum.PARAM_ILLEGAL);
    }
    ...
    public ResponseResult<Void> constraintViolationException(ConstraintViolationException e) {
        ...
        return ResponseResult.ofFailed(ErrorCodeEnum.PARAM_ILLEGAL.getCode(), errorMsg.toString());
    }
    ...
    public ResponseResult<Void> handleBindException(BindException ex) {
        ...
        String errorMsg = ErrorCodeEnum.PARAM_ILLEGAL.getMessage();
        if (Objects.nonNull(fieldError)) {
            errorMsg = fieldError.getDefaultMessage();
        }
        // 生成返回结果
        return ResponseResult.ofFailed(ErrorCodeEnum.PARAM_ILLEGAL.getCode(), errorMsg);
    }
}
