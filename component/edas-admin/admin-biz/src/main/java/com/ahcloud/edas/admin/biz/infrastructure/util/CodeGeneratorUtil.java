...
public class CodeGeneratorUtil {
    ...
    public static void main(String[] args) {
        ...
        //todo 需要生成的表
        String[] tables = new String[]{"sys_app_park", "sys_user_app_scope", "sys_app_config"};
        ...
        String srcPath = projectPath + "/component/edas-admin/admin-biz/src/main/java";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/edas-admin?nullCatalogMeansCurrent=true&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8&useSSL=false")
        ...
        pc.setParent("");
        pc.setEntity("com.ahcloud.edas.admin.biz.infrastructure.repository.bean")
                .setMapper("com.ahcloud.edas.admin.biz.infrastructure.repository.mapper")
        ...
        packageInfo.put(ConstVal.ENTITY, "com.ahcloud.edas.admin.biz.infrastructure.repository.bean");
        packageInfo.put(ConstVal.MAPPER, "com.ahcloud.edas.admin.biz.infrastructure.repository.mapper");
