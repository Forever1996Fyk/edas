package com.ahcloud.edas.powerjob.biz.infrastructure.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseResult<Void> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException e) {
        return ResponseResult.ofFailed(PowerJobRetCodeEnum.PARAM_ILLEGAL);
    }
    ...
    public ResponseResult<Void> constraintViolationException(ConstraintViolationException e) {
        ...
        return ResponseResult.ofFailed(PowerJobRetCodeEnum.PARAM_ILLEGAL.getCode(), errorMsg.toString());
    }
    ...
    public ResponseResult<Void> handleBindException(BindException ex) {
        ...
        String errorMsg = PowerJobRetCodeEnum.PARAM_ILLEGAL.getMessage();
        if (Objects.nonNull(fieldError)) {
            errorMsg = fieldError.getDefaultMessage();
        }
        // 生成返回结果
        return ResponseResult.ofFailed(PowerJobRetCodeEnum.PARAM_ILLEGAL.getCode(), errorMsg);
    }
}
