package com.ahcloud.edas.powerjob.biz.infrastructure.validate;

import com.ahcloud.edas.powerjob.biz.infrastructure.validate.strategy.TimingStrategyHandler;
...
public class TimingStrategyService {
    ...
    private final static List<String> TIPS = Collections.singletonList("It is valid, but has not trigger time list!");
